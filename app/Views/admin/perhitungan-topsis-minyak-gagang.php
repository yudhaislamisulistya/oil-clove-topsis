                ...
                <div class="card-body">
                    <?php if(session()->getFlashData('status') == "success"){ ?>
                        <div class="alert alert-success alert-dismissable alert-style-1">
                            ...
                            <i class="zmdi zmdi-check"></i>Proses Berhasil, Silahkan Cek Hasilnya Disini <a href="<?= route_to('perhitungan_topsis_admin_detail', session()->getFlashdata('kode_seleksi'), 'Minyak Gagang') ?>" class="btn btn-info btn-sm">CEK</a>
                        </div>
                    ...
                    <form action="<?= route_to('perhitungan_topsis_admin_save') ?>" method="post">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <?php foreach (get_alternatif_by_contains("Minyak Gagang") as $key => $value) { ?>
                                    <tr>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php foreach (get_seleksi_by_id_user_dan_group_by_kode_seleksi(session()->get('id_user'), 'Minyak Gagang') as $key => $value) { ?>
                                        <tr>
                                            <td><?= ++$key ?></td>
                                            <td><?= $value->kode_seleksi ?></td>
                                            <td>
                                            <a href="<?= route_to('perhitungan_topsis_admin_detail', $value->kode_seleksi, 'Minyak Gagang') ?>" class="btn btn-primary btn-sm">Detail Perhitungan</a>
