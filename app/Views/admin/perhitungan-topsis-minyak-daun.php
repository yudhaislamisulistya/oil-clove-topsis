                ...
                <div class="card-body">
                    <?php if(session()->getFlashData('status') == "success"){ ?>
                        <div class="alert alert-success alert-dismissable alert-style-1">
                            ...
                            <i class="zmdi zmdi-check"></i>Proses Berhasil, Silahkan Cek Hasilnya Disini <a href="<?= route_to('perhitungan_topsis_admin_detail', session()->getFlashdata('kode_seleksi'), 'Minyak Daun') ?>" class="btn btn-info btn-sm">CEK</a>
                        </div>
                                ...
                                <tbody>
                                    <?php foreach (get_seleksi_by_id_user_dan_group_by_kode_seleksi(session()->get('id_user'), 'Minyak Daun') as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td>
                                            <a href="<?= route_to('perhitungan_topsis_admin_detail', $value->kode_seleksi, 'Minyak Daun') ?>" class="btn btn-primary btn-sm">Detail Perhitungan</a>
