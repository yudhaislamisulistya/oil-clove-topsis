                                    ...
                                    <?php foreach (get_seleksi() as $key => $value) { ?>
                                        <?php if(strpos(get_alternatif_by_kode_alternatif($value->kode_alternatif)['nama_alternatif'], "Minyak Daun") === 0){ ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary btn-sm" href="<?= route_to('perhitungan_topsis_admin_detail', $value->kode_seleksi, 'Minyak Daun') ?>"><i class="bx bx-pencil fs-4"></i>Detail Perhitungan</i></a>
                                                </td>
                                            </tr>
                                        <?php }?>
                                        ...
                                        <?php if(strpos(get_alternatif_by_kode_alternatif($value->kode_alternatif)['nama_alternatif'], "Minyak Gagang") === 0){ ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary btn-sm" href="<?= route_to('perhitungan_topsis_admin_detail', $value->kode_seleksi, 'Minyak Gagang') ?>"><i class="bx bx-pencil fs-4"></i>Detail Perhitungan</i></a>
                                                </td>
                                            </tr>
                                        <?php }?>
