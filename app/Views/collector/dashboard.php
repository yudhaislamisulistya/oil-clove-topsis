                ...
                <div class="col-xl-12 col-md-6 box-col-6 des-xl-50">
                    <div class="card profile-greeting">
                        <div class="card-body text-center p-t-0">
                            <h3 class="font-light">Selamat Datang, Akun Pengepul/Collector!!</h3>
                            <p>Sistem Pendukung Keputusan Penentuan Harga Jual Minyak Cengkeh Dengan Metode Topsis 🥳
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body text-center">
                                <div class="avatar mx-auto mb-2">
                                    <span class="avatar-initial rounded-circle bg-label-success"><i
                                            class="bx bx-blanket fs-4"></i></span>
                                </div>
                            ...
                            <div class="card-body text-center">
                                <div class="avatar mx-auto mb-2">
                                    <span class="avatar-initial rounded-circle bg-label-warning"><i
                                            class="bx bx-braille fs-4"></i></span>
                                </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordernone">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?= ++$key ?></td>
                                    <td><?= get_user_by_id_user($value->id_user)['nama_lengkap'] ?> -
                                        <?= $value->kode_seleksi ?>
                                        (<?= get_user_by_id_user($value->id_user)['role'] == 2 ? "Me" : "Collector" ?>)
                                    </td>
                                    <td>
                                        <ol>
