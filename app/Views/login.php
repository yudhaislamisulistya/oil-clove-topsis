...
<!-- Mirrored from pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/html/vertical-menu-template/auth-login-cover.html by HTTrack Website Copier/3.x [XR&CO'2017], Sun, 04 Sep 2022 17:03:08 GMT -->
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />

    <title>Login | Oil Clover Topsis</title>
...
<body>
        ...
        <div class="authentication-inner row m-0">
            ...
            <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
                <div class="flex-row text-center mx-auto">
                    <img src="<?php base_url() ?>/assets/img/pages/login-bg.png" alt="Auth Cover Bg color" width="520"
                        class="img-fluid authentication-cover-img" data-app-light-img="pages/login-bg.png"
                        data-app-dark-img="pages/login-dark.png">
                    <div class="mx-auto">
                        <h3>Sistem Pendukung Keputusan Penentuan Harga Jual Minyak Cengkeh Dengan Metode Topsis 🥳</h3>
                    </div>
                </div>
            </div>
            <!-- /Left Text -->
                ...
                <div class="w-px-400 mx-auto">
                    ...
                    <div class="app-brand mb-4">
                        <a href="index-2.html" class="app-brand-link gap-2 mb-2">
                            ...
                            <span class="app-brand-text demo h3 mb-0 fw-bold">Oil Clover Topsis</span>
                        </a>
                    </div>
                    <!-- /Logo -->
    ...
    <!-- Vendors JS -->
    <script src="<?php base_url() ?>/assets/vendor/libs/formvalidation/dist/js/FormValidation.min.js"></script>
    <script src="<?php base_url() ?>/assets/vendor/libs/formvalidation/dist/js/plugins/Bootstrap5.min.js"></script>
    <script src="<?php base_url() ?>/assets/vendor/libs/formvalidation/dist/js/plugins/AutoFocus.min.js"></script>
...
<!-- Mirrored from pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/html/vertical-menu-template/auth-login-cover.html by HTTrack Website Copier/3.x [XR&CO'2017], Sun, 04 Sep 2022 17:03:09 GMT -->
