...
<ul class="menu-inner py-1">
    ...
    <li class="menu-item"><a class="menu-link" href="<?= route_to('perhitungan_topsis_admin_index') ?>"><i
                class="menu-icon tf-icons bx bx-basket"></i><span>Perhitungan TOPSIS</span></a></li>
...
<ul class="menu-inner py-1">
    ...
    <li class="menu-item"><a class="menu-link" href="<?= route_to('hasil_panen_collector_index') ?>"><i class="menu-icon tf-icons bx bx-basket"></i><span>Penentuan Hasil Panen</span></a></li>
